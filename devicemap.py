devicemap = {
    ...
    'jactivelte': 'Samsung Galaxy S4 Actice (intl)',
    ...
    'scorpion': 'Sony Z3 Tablet Compact (LTE)',
    'scorpion_mini': 'Motorola Droid Razr M',
    'scorpion_windy': 'Sony Z3 Tablet Compact (Wi-Fi)',
